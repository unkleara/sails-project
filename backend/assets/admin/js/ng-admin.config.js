...
//   'use strict';
//
//   var test = angular.module('adtAdmin.config', []);
//
//   test.constant('modelConfig', {
...
/*(function() {
    ...
    app.config(function (AdminDescription, NgAdminProvider, RestangularProvider) {
        ...
        console.log(Object.keys(adminConfig.models));
        ...
        function buildListViews() {
            ...
            .description('List of post with infinite pagination') // description appears under the title
            .fields([
        ...
        function buildCreationViews() {
            ...
            .fields([
                nga.field('displayName'),
                nga.field('email'),
                nga.field('roles', 'reference_many') // display list of related comments
                .targetEntity(role)
        ...
        function buildEditViews() {
            ...
            user.editionView()
            .title('Edit user "{{ entry.values.displayName }} / {{ entry.values.id }}"')
            .fields([
